        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <RequestForm />
              {isAdmin && (
                <Link href="/admin" className="flex items-center gap-2 px-4 py-2 bg-[#9B1B1B] text-white rounded-lg hover:bg-[#7A1515] transition shadow-md" title="Панель администратора">
            ...
            <div className="sm:hidden mt-4 pb-2 space-y-2 border-t border-white/10 pt-4">
              ...
              {!user && (
                <div className="flex justify-end">
                  <Link href="/login" aria-label="Вход" className="p-2 text-gray-500/40 hover:text-gray-300 transition">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                  </Link>
                </div>
              )}
